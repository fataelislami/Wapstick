...
//        ADMOB CONFIG
        ...
        String admobOptDetailBanner=getString(R.string.admobOptDetailBanner);
        if(admobOptDetailBanner.equals("true")){
            admobAdinit();
        }else{
...
//        FACEBOOK ADS CONFIG
        String facebookOptDetailBanner=getString(R.string.facebookOptDetailBanner);
        String facebookOptDetailInter=getString(R.string.facebookOptDetailInter);
        if(facebookOptDetailBanner.equals("true")){
            facebookAdInit();
        }else{
            LinearLayout adContainer = (LinearLayout) findViewById(R.id.fbAdView);
            adContainer.setVisibility(View.GONE);
        }
        if(facebookOptDetailInter.equals("true")){
