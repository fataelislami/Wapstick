...
import static id.kostlab.stickerapp.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static id.kostlab.stickerapp.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static id.kostlab.stickerapp.StickerContentProvider.PUBLISHER_EMAIL;
import static id.kostlab.stickerapp.StickerContentProvider.PUBLISHER_WEBSITE;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static id.kostlab.stickerapp.StickerContentProvider.IMAGE_DATA_VERSION;
import static id.kostlab.stickerapp.StickerContentProvider.AVOID_CACHE;
